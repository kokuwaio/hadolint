...
[![pulls](https://img.shields.io/docker/pulls/kokuwaio/hadolint)](https://hub.docker.com/repository/docker/kokuwaio/hadolint)
[![size](https://img.shields.io/docker/image-size/kokuwaio/hadolint)](https://hub.docker.com/repository/docker/kokuwaio/hadolint)
[![dockerfile](https://img.shields.io/badge/source-Dockerfile%20-blue)](https://github.com/kokuwaio/hadolint/blob/main/Dockerfile)
[![license](https://img.shields.io/github/license/kokuwaio/hadolint)](https://github.com/kokuwaio/hadolint/blob/main/LICENSE)
[![issues](https://img.shields.io/github/issues/kokuwaio/hadolint)](https://github.com/kokuwaio/hadolint/issues)

A [Woodpecker CI](https://woodpecker-ci.org) plugin for [hadolint](https://github.com/hadolint/hadolint) to lint Dockerfiles.  
